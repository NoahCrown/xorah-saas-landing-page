    ...
    <section>
        <Element name="pricing">
            <div className='container'>
                <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:scroll-pt-16">
                    ...
                    <div className='pricing-bg '>
                        <img className='relative z-2' src='/images/bg-outlines.svg' width={960} height={380} alt='bg-outlines'/>
                        <img className='absolute inset-0 opacity-5 mix-blend-soft-light' src='/images/bg-outlines-fill.svg' width={960} height={380} alt='bg-outlines'/>
                    </div>
                </div>
